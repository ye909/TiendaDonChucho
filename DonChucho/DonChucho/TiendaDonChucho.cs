    ...
    public class TiendaDonChucho                       
    {
        ...
        public DataTable ObtenerInventario()
        {
            try
            {
                ...
                SqlDataAdapter canal = new SqlDataAdapter("SELECT * FROM Inventario", connection);
        ...
        //public int Editarinventario(int idProducto, int idSucursal,int precio, int cantidad)
        //{
        //    int resultado = 0;
